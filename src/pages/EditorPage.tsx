...
const EditorPage = () => {
	...
	return (
		<div className="bg-white dark:bg-gray-950 py-6 sm:py-8 px-0 sm:px-6 lg:px-8">
			...
			{/* Content Container */}
			<div className="relative z-10 px-3 pt-6 pb-16 sm:px-12 sm:pt-8 sm:pb-20 lg:px-16 lg:pt-10 lg:pb-24 xl:px-20 xl:pb-28">
